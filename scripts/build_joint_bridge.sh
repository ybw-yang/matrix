...
echo "[build] cmd_vel_ecal_bridge"
g++ "${DIR}/cmd_vel_ecal_bridge.cpp" "${FLAGS[@]}" -o "${OUT}/cmd_vel_ecal_bridge"
echo "[build] find_walk_mode"
g++ "${DIR}/find_walk_mode.cpp" "${FLAGS[@]}" -o "${OUT}/find_walk_mode"
